...
public abstract class GameObj {
   ...
   *
   * <p>Intersection is determined by comparing bounding boxes. If the bounding boxes overlap, then
  ...
  /**
   * Determine whether this game object will intersect another in the next time step, assuming that
   * both objects continue with their current velocity.
   *
   * <p>Intersection is determined by comparing bounding boxes. If the bounding boxes (for the next
  ...
  /**
   * Update the velocity of the object in response to hitting an obstacle in the given direction. If
   * the direction is null, this method has no effect on the object.
   *
  ...
  /**
   * Determine whether the game object will hit another object in the next time step. If so, return
   * the direction of the other object in relation to this game object.
   *
   * @param that The other object
